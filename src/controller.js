...
let getActor = function (req, res) {
  ...
  let sql =
    "select id, username, first_name, last_name from actors where id = ?";
  let params = [];
  params.push(id);
...
let addActor = function (req, res) {
  ...
  let sql =
    "insert into actors (username, first_name, last_name) values (?, ?, ?);";
  let params = [];
...
let addPlaywright = function (req, res) {
  ...
  let sql =
    "insert into playwrights (playwright_lastName, playwright_firstName) values (?, ?);";
  let params = [];
...
let addActorsLibrary = function (req, res) {
  ...
  let sql =
    "insert into actorsLibrary (actor_id, playwright_id, script_id) values (?, ?, ?);";
  let params = [];
...
let updateActor = function (req, res) {
  ...
  let sql =
    "update actors set username = ?, first_name = ?, last_name = ? where id = ?";
  let params = [newUserName, newFirstName, newLastName, id];
...
let updateScript = function (req, res) {
  ...
  let params = [newActorId, newScriptTitle, id];
...
let updatePlaywright = function (req, res) {
  ...
  let sql =
    "update scripts set actor_id = ?, playwright_lastName = ?, playwright_firstName = ? where id = ?";
  let params = [newActorId, newPlaywrightLastName, newPlaywrightFirstName, id];
...
let updateActorsLibrary = function (req, res) {
  ...
  let sql =
    "update actorsLibrary set actor_id = ?, playwright_id = ?, script_id = ? where id = ?";
  let params = [newActorId, newPlaywrightId, newScriptId, id];
